...
class HabitViewModel: ObservableObject {
  ...
  // essa variável serve pra que, depois de abrir a tela de hábitos na primeira vez, não seja ncessario carregar tudo de novo na segunda (caso mude pra tab gráficos, conta, etc). Ela é observada no onAppear da HabitView
